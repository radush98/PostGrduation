...
def generateBlock():
    ...
    for Sbox in Sboxes:
        strFuns = base4.divideToFunctions(Sbox, False, 256)

        for strFun in strFuns:
            funs4.append([int(num) for num in strFun])
